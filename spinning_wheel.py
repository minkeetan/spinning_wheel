...
NAME_FONT = pygame.font.Font(os.path.join("ldfcomicsans-font", "Ldfcomicsans-jj7l.ttf"), 80)
CLASS_FONT = pygame.font.Font(os.path.join("ldfcomicsans-font", "Ldfcomicsans-jj7l.ttf"), 40)
GAME_FONT = pygame.font.Font(os.path.join("ldfcomicsans-font", "Ldfcomicsans-jj7l.ttf"), 80)
TIPS_FONT = pygame.font.Font(os.path.join("ldfcomicsans-font", "Ldfcomicsans-jj7l.ttf"), 25)
TIME_FONT = pygame.font.Font(os.path.join("ldfcomicsans-font", "Ldfcomicsans-jj7l.ttf"), 60)
